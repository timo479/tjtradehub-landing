...
export default function ChartsVideoSection() {
  ...
  // Sync modal video time with main video when opening
  const openLightbox = () => {
    setLightbox(true);
    setTimeout(() => {
      ...
      >
        ...
        <div className="mx-auto px-6 relative z-10" style={{ maxWidth: "1200px" }}>
          ...
          <div className="relative mx-auto" style={{ maxWidth: "980px" }}>
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 40px 100px rgba(0,0,0,0.85), 0 0 0 1px rgba(139,92,246,0.08)",
              }}
            >
              {/* Browser chrome bar */}
              <div
              ...
              >
                ...
                >
                  <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                    <path d="M1 4.5V1.5H4M9 1.5h3V4.5M12 8.5V11.5H9M4 11.5H1V8.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </button>
              </div>
              ...
              <div className="relative cursor-pointer group" onClick={toggle}>
                ...
                <div
                  ...
                  style={{ opacity: playing ? 0 : 1, background: "rgba(0,0,0,0.45)", pointerEvents: playing ? "none" : "auto" }}
                >
                  <div className="flex items-center justify-center rounded-full" style={{ width: "64px", height: "64px", backgroundColor: "rgba(139,92,246,0.9)", boxShadow: "0 8px 32px rgba(139,92,246,0.5)" }}>
                ...
                {/* Hover overlay */}
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200" style={{ background: "rgba(0,0,0,0.18)" }}>
                  <div className="flex items-center justify-center rounded-full" style={{ width: "56px", height: "56px", backgroundColor: "rgba(139,92,246,0.85)", boxShadow: "0 8px 32px rgba(139,92,246,0.4)" }}>
                    {playing ? (
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-sm mt-3" style={{ color: "#6B7280" }}>No credit card required</p>
          </div>
